...
{"custom_id": "request-1", "method": "POST", "url": "/v1/completions", "body": {"model": "gpt-3.5-turbo-instruct", "prompt": "List 3 names of famous soccer player: ", "max_tokens": 20}}
{"custom_id": "request-2", "method": "POST", "url": "/v1/completions", "body": {"model": "gpt-3.5-turbo-instruct", "prompt": "List 6 names of famous basketball player:  ", "max_tokens": 40}}
{"custom_id": "request-3", "method": "POST", "url": "/v1/completions", "body": {"model": "gpt-3.5-turbo-instruct", "prompt": "List 6 names of famous basketball player:  ", "max_tokens": 40}}
"""
...
class OpenAIBatchProcessor:
    ...
    def process_batch(self, input_file_path, endpoint, completion_window):
        ...
        print('start create batch job time:', start_time)
        ...
        if batch_job.status == "completed":
            end_time = time.time()
            print('end create batch job time:', end_time)
...
input_file_path = "/home/ycwang/mmlu/instruct-eval/data/mmlu/auxiliary_train/race_requests_output.jsonl"
